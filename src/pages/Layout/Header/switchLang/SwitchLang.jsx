        ...
        return (
            <>
                ...
                <div style={{display: switcher ? 'flex' : 'none'}} className="switchLang">
                    <button  onClick={() => changesLanguage('ru')} className={`switchLang__lang__cont ${i18n.language === 'ru' ? 'active' : ''}`}>
                        <p className="switch__lang">Russian</p>
                    </button>
                    <button onClick={() => changesLanguage('en')} className={`switchLang__lang__cont ${i18n.language === 'en' ? 'active' : ''}`}>
